...
\begin{satz}{11.11 Zum Identitätssatz}
Sei $G$ ein Gebiet und $f \in H(G)$. Gibt es eine nicht-diskrete Menge $M \subset G$ mit $f'(z) = 0$ für alle $z \in M$, so ist $f$ konstant.
\end{satz}
